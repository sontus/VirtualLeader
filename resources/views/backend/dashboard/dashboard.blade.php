            ...
            <div class="col-xl-3 col-sm-6 m-t35">
                <div class="card card-coin">
                    <div class="card-body text-center">
                        ...
                        <h2 class="text-black mb-2 font-w600">{{ $categories}}</h2>
                        <p class="mb-0 fs-14">
            ...
            <div class="col-xl-3 col-sm-6 m-t35">
                <div class="card card-coin">
                    <div class="card-body text-center">
                        ...
                        <h2 class="text-black mb-2 font-w600">{{ $mentors}}</h2>
                        <p class="mb-0 fs-14"></h2>
                        <p class="mb-0 fs-14">
                            Mentors
                        </p>
                    </div>
            ...
            <div class="col-xl-3 col-sm-6 m-t35">
                <div class="card card-coin">
                    <div class="card-body text-center">
                        ...
                        <h2 class="text-black mb-2 font-w600">{{ $bookings}}</h2>
                        <p class="mb-0 fs-14">
                            Bookings
                        </p>
                    </div>
