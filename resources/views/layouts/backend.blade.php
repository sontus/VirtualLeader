...
<head>
	...
	<meta name="description" content="VirtualLeader - Web" />
	<meta property="og:title" content="VirtualLeader - Web" />
	<meta property="og:description" content="VirtualLeader - Web" />
    ...
    <title>{{ config('app.name', 'VirtualLeader') }} | @yield('title')</title>
    <!-- Favicon icon -->
